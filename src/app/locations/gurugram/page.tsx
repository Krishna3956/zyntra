...
export const metadata: Metadata = {
  ...
  description:
    "Zyntra in Gurugram - buy, sell, rent and joint-venture property, run out of our Sector 14 head office. Advisory, transactions and land development across the city.",
};

const office = offices.find((o) => o.id === "gurugram")!;
const areas = [
  "Sector 14 & 15",
  "Old Gurugram",
  "Golf Course Road",
  ...
  "Sohna Road",
  "New Gurugram (Dwarka Expressway belt)",
  "MG Road",
  "DLF Phases",
];
  ...
  return (
    <>
      <PageHeader
        ...
        title="Real estate in Gurugram"
        description="From our Sector 14 head office, we help you buy, sell, rent and co-develop property across one of India's most dynamic real estate markets."
      />
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
          <Reveal>
            <div className="card p-8">
              <span className="eyebrow text-gold-deep">Our head office</span>
          ...
          <Reveal delay={100}>
            <div>
              ...
              <p className="mt-3 text-stone">
                We work across Gurugram, with particular depth in the corridors around our
                Sector 14 base and the fast-growing western belt.
              </p>
              ...
              <div className="mt-8 rounded-2xl border border-gold/25 bg-gold/5 p-6">
                <h3 className="font-display text-lg font-semibold text-ink">
                  Own land in or around Gurugram?
                </h3>
      ...
      <CTASection
        ...
        description="Buying, selling, renting or sitting on land you would like to develop - we are ten minutes from Sector 14 market."
