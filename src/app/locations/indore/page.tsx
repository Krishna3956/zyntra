...
export default function IndorePage() {
  const cityProps = properties.filter((p) => p.city === "Indore").slice(0, 3);
      ...
      {cityProps.length > 0 && (
        <section className="container-page py-16 md:py-20">
          ...
          <div className="mt-10 text-center">
            <Link href="/properties?city=Indore" className="btn btn-primary">
              Browse all Indore properties
              <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
        </section>
